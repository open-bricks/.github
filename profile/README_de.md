<p align="center">
  <img src="open-bricks-banner.svg" alt="open-bricks - Local-First Desktop Software Ökosystem" width="700">
</p>
...
<p align="center">
  ...
  <a href="https://github.com/open-bricks"><img src="https://img.shields.io/badge/Öffentliche_Repositories-99_Aktiv-success?style=flat-square&logo=github" alt="Öffentliche Repositories"></a>
...
| Lokale Software bauen, prüfen, paketieren, synchronisieren und Multi-Agenten-Setups steuern | [dev-bricks](https://github.com/dev-bricks) | [DevCenter](https://github.com/dev-bricks/DevCenter), [CodeBox](https://github.com/dev-bricks/CodeBox), [apiprober](https://github.com/dev-bricks/apiprober), [comas](https://github.com/dev-bricks/comas), [sync-master](https://github.com/dev-bricks/sync-master), [sqlite-transit-sync](https://github.com/dev-bricks/sqlite-transit-sync), [safe-start-for-codex](https://github.com/dev-bricks/safe-start-for-codex) |
...
```mermaid
flowchart TD
    subgraph Storage [Lokaler Speicher & Datenschicht]
        A[SQLite Datenbanken]
        B[Lokale Dateien & Markdown]
        C[BibTeX / PDFs / Medien]
    end
    ...
    subgraph Applications [Local-First Desktop & CLI Tools]
        ...
        F[dev-bricks<br/>DevCenter, comas, sync-master, lock-master, CodeBox]
    end
    ...
    subgraph Science [Forschung & Spezialisierte Domänen]
        ...
        K[um-bruch<br/>Civic Tech & Gesundheitspolitik]
    end
...
| [entertain-and-more](https://github.com/entertain-and-more) | 2 | Lokale Spiele und kreative Utilities mit optionaler KI-Unterstützung | [ChatAndChess](https://github.com/entertain-and-more/ChatAndChess), [rpx](https://github.com/entertain-and-more/rpx) |
...
- `dev-bricks comas multi-agent status suite`
...
<p align="center">
  <strong>open-bricks</strong> - Open-Source-Software für lokales Arbeiten im KI-Zeitalter.<br>
