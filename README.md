...
| Path | Purpose |
|---|---|
| `profile/README.md` | Public organization landing page shown on `github.com/open-bricks` (English) |
| `profile/README_de.md` | Public organization landing page (German version) |
...
| [`dev-bricks`](https://github.com/dev-bricks) | 15 active product repos: developer tools, editors, API discovery, agent status suites, file locks, tickets, sync yards, and startup gates |
| [`ellmos-ai`](https://github.com/ellmos-ai) | 36 active product repos: LLM operating systems, MCP servers, local agent memory, media tooling, connectors, computer-use modules, and portable agent utilities |
...
| [`entertain-and-more`](https://github.com/entertain-and-more) | 2 active product repos: local games, tabletop RPG tools, and AI-assisted creative utilities |
...
Verified public index on 2026-07-27: 89 active public product or research repositories plus 10 active public `.github` profile repositories across the linked organizations (99 active public repositories in total). Archived public repositories remain intentionally excluded from active counts.
